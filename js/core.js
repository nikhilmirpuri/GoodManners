...
$(document).keydown(function (keyEvent) {
  if (!keyEvent.originalEvent.repeat) {
    if (keyEvent.keyCode == 82) {
      $("#whistlebottom").toggle(toShow);
      $("#whistle").toggle(!toShow);
      toShow = !toShow;
...
$(document).keydown(function (keyEvent) {
  if (!keyEvent.originalEvent.repeat) {
    if (keyEvent.keyCode == 69) {
      $("#throatbottom").toggle(toShow);
      $("#throat").toggle(!toShow);
      toShow = !toShow;
      prevKeyCode = keyEvent.keyCode;
    }
  }
